...
%											    Kapitel 1 - Einleitung
	...
	\chapter[Fazit und Ausblick - Anja Wolf]{Fazit und Ausblick}
		...
		Zusammenfassend lässt sich sagen, dass die vom Projektteam aufgestellten Anforderungen an die Implementierung eines Webscrapers für die Website Tripadvisor erfüllt werden konnten. Mit diesem hat der Anwender nun die Möglichkeit, alle gespeicherten Daten zu einem Restaurant inklusive dessen Bewertungen in kürzester Zeit in einer eigenen Datenbank abzulegen und diese beliebig weiter zu verwenden. Mit dem Einsatz der Programmiersprache Python und verschiedenster Bibliotheken konnte sowohl das Ziehen als auch das Speichern der Daten in einer TinyDB Datenbank sehr effizient umgesetzt werden.  
		\\
		Lediglich bei der Eingabe des Anwenders wurde nach einer ersten Analyse der Website die Anforderung an das Programm nochmals überarbeitet und die einfache Eingabe einer URL als ausreichend erachtet. Da Tripadvisor eine komplexe URL mit automatisch generierter API für jedes angelegte Restaurant hat, ist ohne Zugriff auf diese das Scrapen mit der lediglichen Eingabe von Restaurant Name und Ort nicht einfach möglich. Daher hat sich das Projektteam gegen diese Methode und für die Eingabe der URL des zu scrapenden Restaurants entschieden. Dies könnte in einem weiteren Schritt nochmals überarbeitet werden um die Anwendung im Bereich Benutzerfreundlichkeit zu verbessern.  
		\\
...
%   									Literaturverzeichnis	
	...
	\begin{thebibliography}{9} 
		...
		Hofbräuhaus \url{https://www.tripadvisor.de/Restaurant_Review-g187309-d742684-
		Reviews-Hofbraeuhaus-Munich_Upper_Bavaria_Bavaria.html}, aufgerufen am 9. Juni 2018
